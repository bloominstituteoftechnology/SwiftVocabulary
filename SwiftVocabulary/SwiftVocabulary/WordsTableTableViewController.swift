...
class WordsTableTableViewController: UITableViewController {
    ...
    var vocabWords : [VocabularyWord] = [VocabularyWord(word: "run", definition: "runn"), VocabularyWord(word: "yo", definition: "yoo"), VocabularyWord(word: "Two", definition: "Two is a number.")]
