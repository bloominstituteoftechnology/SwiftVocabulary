...
extension UIViewController {
    ...
    func presentAlertWithInput(title: String, message: String, vc: UIViewController, complete: @escaping (_ result: VocabularyWord) -> Void) { //completion block explained below
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert)
