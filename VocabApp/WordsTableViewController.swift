...
class WordsTableViewController: UITableViewController {
    ...
    let vocabWords: [VocabularyWord] = [VocabularyWord(word: "Function", definition: "A method that executes a task" ),
                                        VocabularyWord(word: "Class", definition: "A reference type customa data type"),
